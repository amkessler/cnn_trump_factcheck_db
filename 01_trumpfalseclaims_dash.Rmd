...
Time-based Rankings (All) 
===================================== 
Some rankings of all Trump false claims  
...
### Top individual days for falsehoods
...
d <- ggplot(data = bytopdates, aes(x = reorder(date, n), y = n)) +
  geom_col(
    # color = "#848484",
    fill = "#CC3300") +
  coord_flip() +
...
e <- ggplot(data = bytopweeks, aes(x = reorder(isoweek, n), y = n)) +
  geom_col(
    # color = "#848484",
    fill = "#CC3300") +
  coord_flip() +
...
e <- ggplot(data = bytopmonths, aes(x = reorder(month, n), y = n)) +
  geom_col(
    # color = "#848484",
    fill = "#CC3300") +
  coord_flip() +
