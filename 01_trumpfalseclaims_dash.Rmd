...
valueBox(num_forums, icon = "fa-users", color = "#A8E9A8")
...
valueBox(subject_count_PREVWEEK, icon = "fa-book", color = "#f4a8a7")
...
valueBox(subject_count, icon = "fa-book", color = "#f4a8a7")
