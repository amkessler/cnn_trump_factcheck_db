...
valueBox(avg_per_day, icon = "fa-pencil", color = "lightblue")
...
valueBox(avg_per_day_prevweek, color = "blue")
...
valueBox(avg_per_week, color = "blue")
...
valueBox(avg_per_month, color = "blue")
