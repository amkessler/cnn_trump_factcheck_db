...
raw_data <- read_excel("TRUMP FACT-CHECKS.xlsx", 
    sheet = "ak_forstorytest", col_types = c("date", 
...
### `r fcheck$code_name[1]`

`r fcheck$claim[1]` -- `r format(fcheck$date[1], '%B %d')` at `r fcheck$forum[1]`

**Facts First:** *`r fcheck$factcheck_factsfirst[1]`*

`r fcheck$factcheck_moretext[1]`


<!-- sample loop for markdown formatting https://stackoverflow.com/questions/17178831/generate-markdown-comments-within-for-loop -->
